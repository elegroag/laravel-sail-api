    ...
    public function store(Request $request)
    {
        try {
            $data = $request->validate([
                ...
                'is_disabled' => 'boolean',
                'is_readonly' => 'boolean',
                'data_source' => 'nullable|array|required_if:search_type,local',
                'css_classes' => 'nullable|string|max:255',
                'help_text' => 'nullable|string',
                'target' => 'integer|min:-1',
                'event_config' => 'nullable|array',
                'search_type' => 'nullable|in:local,ajax,collection',
                'search_endpoint' => 'nullable|string|min:160|required_if:search_type,ajax',
