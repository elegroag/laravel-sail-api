...
<div class='row'>
    ...
    <div class='col-md-4 col-lg-3 border-top border-end'>
        ...
        <p class='pl-1 description'>{{ capitalize($trabajador->getRazsoc()) }}</p>
    </div>
    <div class='col-md-4 col-lg-3 border-top border-end'>
    ...
    <div class='col-md-4 col-lg-3 border-top border-end'>
        ...
        <p class='pl-1 description'>{{ capitalize($trabajador->getPriape() . ' ' . $trabajador->getSegape()) }}</p>
    </div>
    <div class='col-md-4 col-lg-3 border-top border-start border-end'>
        <label class='form-control-label'>Nombres</label>
        <p class='pl-1 description'>{{ capitalize($trabajador->getPrinom() . ' ' . $trabajador->getSegnom()) }}</p>
    </div>
    <div class='col-md-4 col-lg-3 border-top border-end'>
    ...
    <div class='col-md-4 col-lg-3 border-top border-end'>
        ...
        <p class='pl-1 description'>{{ capitalize(@$_codciu[$trabajador->getCodciu()]) }}</p>
    </div>
    <div class='col-md-4 col-lg-3 border-top border-end'>
    ...
    <div class='col-md-4 col-lg-3 border-top border-end'>
        ...
        <p class='pl-1 description'>{{ capitalize(@$_codzon[$trabajador->getCodzon()]) }}</p>
    </div>
    <div class='col-md-4 col-lg-3 border-top border-start border-end'>
