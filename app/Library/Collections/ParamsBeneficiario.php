...
class ParamsBeneficiario
{
    ...
    public static $huerfano;

    public static $tipo_hijo;

    public static $calendario;

    public static $tiene_giro;
    ...
    {
        foreach (self::$datos_captura['parent'] as $data) {
            self::$parentesco[$data['estado']] = $data['detalle'];
        }
    ...
    {
        foreach (self::$datos_captura['huerfano'] as $data) {
            self::$huerfano[$data['estado']] = $data['detalle'];
        }
    ...
    {
        foreach (self::$datos_captura['tiphij'] as $data) {
            self::$tipo_hijo[$data['estado']] = $data['detalle'];
        }
    ...
    {
        foreach (self::$datos_captura['calendario'] as $data) {
            self::$calendario[$data['estado']] = $data['detalle'];
        }
    ...
    public static function getTieneGiro()
    {
        foreach (self::$datos_captura['giro'] as $data) {
            self::$tiene_giro[$data['estado']] = $data['detalle'];
        }
    ...
    {
        foreach (self::$datos_captura['pago'] as $data) {
            self::$pago[$data['estado']] = $data['detalle'];
        }
