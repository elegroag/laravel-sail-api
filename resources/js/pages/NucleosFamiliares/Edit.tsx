...
export default function Edit({ nucleo_familiar, trabajadores }: Props) {
    ...
    // Cargar datos del núcleo familiar al montar el componente
    useEffect(() => {
        setFormData({
            nombres: nucleo_familiar.nombres || '',
            apellidos: nucleo_familiar.apellidos || '',
            rut: nucleo_familiar.rut || '',
            fecha_nacimiento: nucleo_familiar.fecha_nacimiento || '',
            genero: nucleo_familiar.genero || '',
            parentesco: nucleo_familiar.parentesco || '',
            telefono: nucleo_familiar.telefono || '',
            email: nucleo_familiar.email || '',
            direccion: nucleo_familiar.direccion || '',
            estado_civil: nucleo_familiar.estado_civil || '',
            ocupacion: nucleo_familiar.ocupacion || '',
            dependiente_economico: nucleo_familiar.dependiente_economico || false,
            trabajador_id: nucleo_familiar.trabajador_id?.toString() || ''
        });
    }, [nucleo_familiar]);
    ...
    return (
        <AppLayout title="Editar Núcleo Familiar">
                ...
                <div className="px-4 py-5 sm:px-6">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end pt-6">
                            ...
                            >
                                {processing ? 'Actualizando...' : 'Actualizar Familiar'}
                            </button>
                        </div>
                    </form>
                </div>
