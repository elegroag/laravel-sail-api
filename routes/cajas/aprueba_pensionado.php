...
Route::middleware([CajasCookieAuthenticated::class])->group(function () {
    Route::prefix('aprobacionpen')->group(function () {
        Route::get('/', [ApruebaPensionadoController::class, 'indexAction']);
        Route::post('aplicar-filtro', [ApruebaPensionadoController::class, 'aplicarFiltroAction']);
        Route::post('buscar', [ApruebaPensionadoController::class, 'buscarAction']);
