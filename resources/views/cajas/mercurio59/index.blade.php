...
Tag::addJavascript('Cajas/movile/mercurio59');
                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Tag::hiddenField("codinf", "value: {$codinf}"); ?>
                            <?php echo Tag::selectStatic("codser", $_codser, "use_dummy: true", "select2: true", "dummyValue: ", "class: form-control"); ?>
                        </div>
                        <div class="form-group">
                            <label for="numero" class="form-control-label">Numero</label>
                            <span id='td_apertura'>
                                <?php echo Tag::selectStatic("numero", array(), "class: form-control", "use_dummy: true", "dummyValue: "); ?>
                            </span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Tag::selectStatic("precan", $Mercurio59->getPrecanArray(), "class: form-control", "use_dummy: true", "dummyValue: "); ?>
                        </div>
                        <div class="form-group">
                            <label for="autser" class="form-control-label">Automatico Servicio?</label>
                            <?php echo Tag::selectStatic("autser", $Mercurio59->getAutserArray(), "class: form-control", "use_dummy: true", "dummyValue: "); ?>
                        </div>
                        <div class="form-group">
                            <label for="consumo" class="form-control-label">Valida Consumo?</label>
                            <?php echo Tag::selectStatic("consumo", $Mercurio59->getConsumoArray(), "class: form-control", "use_dummy: true", "dummyValue: "); ?>
                        </div>
                        <div class="form-group">
                            <label for="estado" class="form-control-label">Estado</label>
                            <?php echo Tag::selectStatic("estado", $Mercurio59->getEstadoArray(), "class: form-control", "use_dummy: true", "dummyValue: "); ?>
                        </div>
                        <div class="form-group">
