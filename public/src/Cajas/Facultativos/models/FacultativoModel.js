...
export default class FacultativoModel extends Backbone.Model {
	constructor(options) {
		super(options);
	}
	...
	validate(attr = {}) {
		return RulesValidator(FacultativoModel.Rules.rules, attr);
	}
	...
	static Rules = {
		...
		messages: {
			...
			email: { required: 'Debe tener formato de email correcto.', email:'El campo email debe ser un email.' },
			...
			fecini: { required: 'El campo fecini es obligatorio.', date:'El campo fecini debe ser una fecha.' },
