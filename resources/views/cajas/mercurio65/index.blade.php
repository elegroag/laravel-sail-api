                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            @php echo Tag::hiddenField("codsed", "class: form-control"); @endphp
                            @php echo Tag::numericField("nit", "class: form-control", "placeholder: Nit"); @endphp
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @php echo Tag::select("codcla", $Mercurio67->find(), "using: codcla,detalle", "class: form-control", "use_dummy: true", "dummyValue: "); @endphp
                        </div>
                        <div class="form-group">
                            <label for="detalle" class="form-control-label">Detalle</label>
                            @php echo Tag::numericField("detalle", "class: form-control", "placeholder: Detalle"); @endphp
                        </div>
                        <div class="form-group">
                            <label for="lat" class="form-control-label">Latitud</label>
                            @php echo Tag::textField("lat", "class: form-control", "placeholder: Latitud"); @endphp
                        </div>
                        <div class="form-group">
                            <label for="log" class="form-control-label">Longitud</label>
                            @php echo Tag::textField("log", "class: form-control", "placeholder: Longitud"); @endphp
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @php echo Tag::selectStatic("estado", $Mercurio65->getEstadoArray(), "use_dummy: true", "dummyValue: ", "class: form-control"); @endphp
                        </div>
...
<script src="{{ asset('Cajas/movile/mercurio65.js') }}"></script>
