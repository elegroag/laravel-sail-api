...
return [
    ...
    [
        ...
        'group_id' => 0,
        'order' => 0,
        'default_value' => 'I',  // Valor por defecto para independientes
        'is_disabled' => true,
        'is_readonly' => true,
        'css_classes' => 'd-none',
        'help_text' => 'Campo de sistema - Calificación del afiliado independiente',
        'target' => -1,
    ...
    [
        ...
        'validacion' => [
            ...
            'max_length' => 5,
            'field_size' => 5,
            'detail_info' => 'Tipo de documento de identificación del afiliado independiente',
            'error_messages' => [
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Ingrese el primer nombre del trabajador independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'min_length' => 2,
            'max_length' => 100,
            'field_size' => 100,
            'detail_info' => 'Primer nombre del afiliado independiente',
    ...
    [
        ...
        'validacion' => [
            ...
            'max_length' => 100,
            'field_size' => 100,
            'detail_info' => 'Segundo nombre del afiliado independiente (opcional)',
            'pattern' => '^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s\'-]*$',
            'error_messages' => [
                'min_length' => 'El nombre debe tener al menos 2 caracteres',
                'max_length' => 'El nombre no puede exceder 100 caracteres',
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Ingrese el primer apellido del trabajador independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'min_length' => 2,
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Seleccione la fecha de nacimiento del trabajador independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'css_classes' => 'form-select',
        'help_text' => 'Seleccione el sexo del trabajador independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Ingrese la dirección donde desarrolla su actividad independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => false,
            'max_length' => 255,
    ...
    [
        ...
        'css_classes' => 'form-select',
        'help_text' => 'Seleccione la zona donde desarrolla su actividad independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'css_classes' => 'form-select',
        'help_text' => '¿Desarrolla su actividad independiente en zona rural?',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'data_source' => [], // Se llenará dinámicamente
        'css_classes' => 'form-select',
        'help_text' => 'Seleccione la actividad económica según CIUU que desarrolla como independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'data_source' => [], // Se llenará dinámicamente
        'css_classes' => 'form-select',
        'help_text' => 'Seleccione su ocupación o cargo como trabajador independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Fecha de inicio de su actividad como independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Ingrese el promedio de sus ingresos mensuales como independiente',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'min_length' => 0,
            'field_size' => 12,
            'detail_info' => 'Ingresos mensuales del trabajador independiente',
            'error_messages' => [
    ...
    [
        ...
        'data_source' => [
            ...
            ['value' => 'MIXTO', 'label' => 'Mixtos']
        ],
        'css_classes' => 'form-select',
        'help_text' => 'Seleccione el tipo de ingresos que recibe',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
                'required' => 'El tipo de ingresos es obligatorio'
            ]
        ]
    ],
    [
