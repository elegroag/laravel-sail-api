	...
	<div class='row g-3'>
		...
		<div class='col-md-6 col-lg-3' group-for='pymes'>
			<div class='d-flex align-items-center'>
				...
				<select name="pymes" id="pymes" class="form-control">
                    <option value="">Seleccione un tipo de documento</option>
		...
		<div class='col-md-6 col-lg-3' group-for='tipemp'>
			<div class='d-flex align-items-center'>
				...
				<select name="tipemp" id="tipemp" class="form-control">
                    <option value="">Seleccione un tipo de documento</option>
		...
		<div class='col-md-6 col-lg-3' group-for='tipapo'>
			<div class='d-flex align-items-center'>
				...
				<select name="tipapo" id="tipapo" class="form-control">
                    <option value="">Seleccione un tipo de documento</option>
		...
		<div class='col-md-6 col-lg-4' group-for='tipsoc'>
			<div class='d-flex align-items-center'>
				...
				<select name="tipsoc" id="tipsoc" class="form-control">
                    <option value="">Seleccione un tipo de documento</option>
		...
		<div class='col-md-6 col-lg-4' group-for='ofiafi'>
			<div class='d-flex align-items-center'>
				...
				<select name="ofiafi" id="ofiafi" class="form-control">
                    <option value="">Seleccione un tipo de documento</option>
		...
		@include('cajas.templates.tmp_checklist_validacion_control_empresa')
