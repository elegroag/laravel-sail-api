    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:20px;">
                <div class="row">
                    ...
                    <div class="form-group" style="padding:5px;">
                        {!! Tag::button("Adicionar", "class: btn btn-success btn-sm", "onclick: addFiltro();") !!}
                        {!! Tag::button("Borrar", "class: btn btn-info btn-sm", "onclick: borrarFiltro();") !!}
                    </div>
                </div>
                            ...
                            @if(isset($filters) && $filters != false)
                                @foreach($filters['campo'] as $xk => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <button type='button' class='btn btn-danger btn-sm' onclick='removeFiltro(this);'>
            ...
            <div class="modal-footer">
                @if ($funcion == '')
                    {!! Tag::button("Aplicar", "class: btn btn-primary btn-sm", "onclick: aplicarFiltro();") !!}
                @else
                    {!! Tag::button("Aplicar", "class: btn btn-primary btn-sm", "onclick: {$funcion}();") !!}
                @endif
