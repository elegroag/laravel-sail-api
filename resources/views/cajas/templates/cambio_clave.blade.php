        ...
        <tr>
            <td style="padding:0px;margin:0px;border:0px">
                <table cellpadding="0" cellspacing="0" align="left" style="
                        ...
                        background-image:url(https://comfacaenlinea.com.co/public/img/membrete_oficios_cobros.jpg);
                        color:#000 !important;
                        border:0px">
                    <tbody>
                        <tr>
                            <td style="
                                ...
                                <div style="height:140px;width:100%;padding-top:20px">
                                    ...
                                    <a style="font-family:Helvetica,
                                        ...
                                        line-height:20px;
                                        color:#478eae;
                                        text-decoration:none" href="https://www.comfacaenlinea.com.co" target="_blank">www.comfacaenlinea.com.co</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
