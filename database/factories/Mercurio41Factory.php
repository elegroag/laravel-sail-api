...
/**
 * Factory para el modelo Mercurio41.
 * Genera datos de prueba para la tabla mercurio41.
 */
class Mercurio41Factory extends Factory
{
    /**
     * El modelo asociado con este factory.
     */
    protected $model = Mercurio41::class;
