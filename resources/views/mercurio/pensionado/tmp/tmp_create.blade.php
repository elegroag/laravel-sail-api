<div class="tab-content" id="pills-tabContent">
    <div class="tab-pane fade show active" id="datos_solicitud" role="tabpanel" aria-labelledby="datos_solicitud-tab">
        <div class="card-body">
            <?= Tag::form("", "id: formRequest", "class: validation_form", "autocomplete: off", "novalidate"); ?>
            <div class="d-none">
                <?= Tag::numericField("id", "class: d-none", "event: is_numeric"); ?>
                <?= Tag::textUpperField("calemp", "class: d-none", "value: P"); ?>
                <?= Tag::textUpperField("coddocrepleg", "class: d-none", "value: "); ?>
            </div>
            <div class="row">
                <div class="col-12">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" group-for='cedtra'>
                                    ...
                                    <?= Tag::numericField("cedtra", "type: number", "class: form-control", "placeholder: Cedula representante", "event: is_numeric"); ?>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" group-for='salario'>
                                    ...
                                    <?= Tag::numericField("salario", "class: form-control", "placeholder: Salario", "type: number"); ?>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" group-for='telefono'>
                                    ...
                                    <?= Tag::numericField("telefono", "type: number", "class: form-control", "placeholder: Telefono con Indicativo", "type: number", "event: is_numeric"); ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group" group-for='celular'>
                                    ...
                                    <?= Tag::numericField("celular", "type: number", "class: form-control", "placeholder: Celular", "type: number", "event: is_numeric"); ?>
                                </div>
                            </div>
