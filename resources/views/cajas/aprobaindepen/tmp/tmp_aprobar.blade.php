    ...
    <div class='row g-3'>
        <div class='col-md-6 col-lg-3' group-for='codind'>
            <div class='d-flex align-items-center'>
                ...
                <select name="codind" class="form-control" use_dummy="true" dummyValue="Seleccione un índice" value="">
        ...
        <div class='col-md-6 col-lg-3' group-for='todmes'>
            <div class='d-flex align-items-center'>
                ...
                <select name="todmes" class="form-control" use_dummy="true" dummyValue="Seleccione opción">
                    <option value="">Seleccione un tipo de documento</option>
        ...
        <div class='col-md-6 col-lg-3' group-for='tipapo'>
            <div class='d-flex align-items-center'>
                ...
                <select name="tipapo" class="form-control" use_dummy="true" dummyValue="Seleccione tipo aportante" value="">
                    <option value="">Seleccione un tipo de documento</option>
        ...
        <div class='col-md-6 col-lg-3' group-for='tipsoc'>
            <div class='d-flex align-items-center'>
                ...
                <select name="tipsoc" class="form-control" use_dummy="true" dummyValue="Seleccione tipo sociedad" value="">
                    <option value="">Seleccione un tipo de documento</option>
		...
		<div class='col-md-4' group-for='tippag'>
            <div class='d-flex align-items-center'>
                ...
                <select name="tippag" class="form-control" use_dummy="true" dummyValue="Seleccione tipo de pago" value="">
                    <option value="">Seleccione un tipo de documento</option>
        ...
        <div class='col-md-4' group-for='codban'>
            <div class='d-flex align-items-center'>
                ...
                <select name="codban" class="form-control" use_dummy="true" dummyValue="Seleccione banco" value="">
                    <option value="">Seleccione un tipo de documento</option>
        ...
        <div class='col-md-4' group-for='tipcue'>
            <div class='d-flex align-items-center'>
                ...
                <select name="tipcue" class="form-control" use_dummy="true" dummyValue="Seleccione tipo de cuenta" value="">
                    <option value="">Seleccione un tipo de documento</option>
        ...
        <div class='col-md-3' group-for='giro'>
            <div class='d-flex align-items-center'>
                ...
                <select name="giro" class="form-control" use_dummy="true" dummyValue="Seleccione giro" value="">
                    <option value="">Seleccione un tipo de documento</option>
        ...
        <div class='col-md-4' group-for='codgir'>
            <div class='d-flex align-items-center'>
                ...
                <select name="codgir" class="form-control" use_dummy="true" dummyValue="Seleccione motivo" value="">
                    <option value="">Seleccione un tipo de documento</option>
