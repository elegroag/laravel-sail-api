...
class BeneficiarioController extends ApplicationController
{
    ...
    public function serializeData(Request $request)
    {
        ...
        return [
            ...
            'huerfano' => $request->input('huerfano'),
            ...
            'biotipdoc' => $request->input('biotipdoc'),
            'biocodciu' => $request->input('biocodciu'),
            'biodesco' => $request->input('biodesco'),
            'biodire' => $request->input('biodire'),
            'bioemail' => $request->input('bioemail'),
            'biophone' => $request->input('biophone'),
            'biopriape' => $request->input('biopriape'),
            'bioprinom' => $request->input('bioprinom'),
            'biosegape' => $request->input('biosegape'),
            'biosegnom' => $request->input('biosegnom'),
            'biourbana' => $request->input('biourbana'),
