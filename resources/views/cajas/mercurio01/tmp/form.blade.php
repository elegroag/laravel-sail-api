...
<div class="form-group">
    ...
    <?php echo Tag::textField("clave", "class: form-control", "placeholder: Clave"); ?>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <?php echo Tag::textField("ftpserver", "class: form-control", "placeholder: Path"); ?>
</div>
<div class="form-group">
    <label for="pathserver" class="form-control-label">pathserver</label>
    <?php echo Tag::textField("pathserver", "class: form-control", "placeholder: Path Server"); ?>
</div>
<div class="form-group">
    <label for="userserver" class="form-control-label">userserver</label>
    <?php echo Tag::textField("userserver", "class: form-control", "placeholder: userserver"); ?>
</div>
<div class="form-group">
    <label for="passserver" class="form-control-label">passserver</label>
    <?php echo Tag::textField("passserver", "class: form-control", "placeholder: passserver"); ?>
</div>
