...
class Gener42Seeder extends Seeder
{
    ...
    {
        $sqlPath = database_path('seeders/dbsql/Gener42.sql');

        if (! File::exists($sqlPath)) {
            throw new RuntimeException('No se encontró el archivo SQL para el seeder Gener42.');
        }
