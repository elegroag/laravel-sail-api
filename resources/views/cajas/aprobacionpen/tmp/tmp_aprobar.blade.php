    ...
    <div class='row g-3'>
        ...
        <div class='col-md-4' group-for='diahab'>
            <div class='d-flex align-items-center'>
                ...
                <?= Tag::textField("diahab", "class: form-control", "placeholder: Ingrese día habil de pago"); ?>
            </div>
        </div>
        ...
        <div class='col-md-4' group-for='codban'>
            <div class='d-flex align-items-center'>
                ...
                <?= Tag::selectStatic("codban", $_bancos, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción", "value:"); ?>
            </div>
        </div>
		...
		<div class='col-md-4' group-for='fecapr'>
            <div class='d-flex align-items-center'>
                ...
                <?= TagUser::calendar("fecapr", "class: form-control", "placeholder: Ingrese fecha aprobación"); ?>
            </div>
        </div>
		<div class='col-md-3' group-for='fecafi'>
            <div class='d-flex align-items-center'>
                <label for='fecafi' class='form-label me-2 mb-0 flex-shrink-0'>Fecha afiliación</label>
                <?= TagUser::calendar("fecafi", "class: form-control", "placeholder: Ingrese fecha afiliación"); ?>
            </div>
        </div>
