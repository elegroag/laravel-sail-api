...
class FormularioIndependiente extends Documento
{
    ...
    function dataEmpleador()
    {
        ...
        $datos = array(
            ...
            array('lb' => 'nit', 'texto' => $this->independiente->getCedtra(), 'x' => 158, 'y' => 54),
            array('lb' => 'Sucursal', 'texto' => $razon_social, 'x' => 9, 'y' => 62),
            array('lb' => 'Telefono', 'texto' => $this->independiente->getTelefono(), 'x' => 170, 'y' => 62),
        );
        $this->addBloq($datos);
    }
    ...
    function dataTrabajador()
    {
        ...
        $datos = array(
            ...
            array('lb' => 'Celular', 'texto' => $this->independiente->getTelefono(), 'x' => 82, 'y' => 76),
            array('lb' => 'Email', 'texto' => $this->independiente->getEmail(), 'x' => 125, 'y' => 76),
            array('lb' => 'Primer apellido', 'texto' => $this->independiente->getPriape(), 'x' => 10, 'y' => 83),
            array('lb' => 'Segundo apellido', 'texto' => $this->independiente->getSegape(), 'x' => 54, 'y' => 83),
            array('lb' => 'Primer nombre', 'texto' => $this->independiente->getPrinom(), 'x' => 105, 'y' => 83),
            array('lb' => 'Segundo nombre', 'texto' => $this->independiente->getSegnom(), 'x' => 155, 'y' => 83),
            array('lb' => 'Fecha nacimiento año', 'texto' => substr($this->independiente->getFecnac(), 0, 4), 'x' => 15, 'y' => 92),
            array('lb' => 'Fecha nacimiento mes', 'texto' => substr($this->independiente->getFecnac(), 5, 2), 'x' => 31, 'y' => 92),
            array('lb' => 'Fecha nacimiento día', 'texto' => substr($this->independiente->getFecnac(), 8, 2), 'x' => 45, 'y' => 92),
            $this->posSexo(),
            $this->posEstadoCivil(),
            $this->posZonaResidencial(),
            array('lb' => 'Dirección recidencia', 'texto' => $this->independiente->getDireccion(), 'x' => 10, 'y' => 100),
            array('lb' => 'Barrio', 'texto' => $this->independiente->getBarrio(), 'x' => 70, 'y' => 100),
    ...
    function dataLaboral()
    {
        ...
        $datos = array(
            array('lb' => 'Fecha inicia año', 'texto' => substr($this->independiente->getFecini(), 0, 4), 'x' => 15, 'y' => 180),
            array('lb' => 'Fecha inicia mes', 'texto' => substr($this->independiente->getFecini(), 5, 2), 'x' => 31, 'y' => 180),
            array('lb' => 'Fecha inicia día', 'texto' => substr($this->independiente->getFecini(), 8, 2), 'x' => 45, 'y' => 180),
            array('lb' => 'Tipo contrato', 'texto' => 'X', 'x' => 80, 'y' => 180),
            array('lb' => 'Jornada', 'texto' => 'X', 'x' => 92, 'y' => 180),
            array('lb' => 'Salario', 'texto' => $this->independiente->getSalario(), 'x' => 135, 'y' => 180),
            array('lb' => 'Comisión', 'texto' => 'X', 'x' => 182, 'y' => 180),
            array('lb' => 'Sector agro', 'texto' => 'X', 'x' => 195, 'y' => 180),
            array('lb' => 'Direccion laboral', 'texto' => $this->independiente->getDireccion(), 'x' => 10, 'y' => 188),
            $this->posZonaLaboral(),
    ...
    function dataMedioPago()
    {
        ...
        $datos = array(
            ...
            array('lb' => 'Documento beneficio giro', 'texto' => $this->independiente->getCedtra(), 'x' => 112, 'y' => 209),
            array('lb' => 'Tipo afiliado beneficio', 'texto' => 'X', 'x' => 164, 'y' => 209),
            $this->posTipoPago(),
            array('lb' => 'Número cuenta', 'texto' => $this->independiente->getNumcue(), 'x' => 52, 'y' => 218),
