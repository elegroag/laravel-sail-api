    ...
    public function run(): void
    {
        DB::transaction(function (): void {
            ...
            $menu_mercurio = [
                ...
                ["id" => 27, "title" => "Servicio domestico", "default_url" => "cajas/aprobaciondom/index", "icon" => NULL, "color" => "text-primary", "nota" => "texto", "position" => "6", "parent_id" => "5", "is_visible" => "1", "codapl" => "CA", "tipo" => "A"],
            ...
            $menu_cajas = [
                ...
                ["id" => 194, "title" => "Certificado de Afiliacion", "default_url" => "mercurio/subsidio/certificado_afiliacion_view", "icon" => NULL, "color" => "", "nota" => "texto", "position" => "1", "parent_id" => "193", "is_visible" => "1", "codapl" => "ME", "tipo" => "T"],
                ...
                ["id" => 197, "title" => "Buscar Historial", "default_url" => "mercurio/movimientos/historial", "icon" => NULL, "color" => "", "nota" => "texto", "position" => "2", "parent_id" => "195", "is_visible" => "1", "codapl" => "ME", "tipo" => "T"],
                ...
                ["id" => 214, "title" => "Certificado de Afiliacion", "default_url" => "mercurio/subsidioemp/certificado_afiliacion_view", "icon" => NULL, "color" => "", "nota" => "texto", "position" => "1", "parent_id" => "213", "is_visible" => "1", "codapl" => "ME", "tipo" => "E"],
                ["id" => 215, "title" => "Certificado para el Trabajador", "default_url" => "mercurio/subsidioemp/certificado_para_trabajador_view", "icon" => NULL, "color" => "", "nota" => "texto", "position" => "2", "parent_id" => "213", "is_visible" => "1", "codapl" => "ME", "tipo" => "E"],
                ...
                ["id" => 218, "title" => "Buscar Historial", "default_url" => "mercurio/movimientos/historial", "icon" => NULL, "color" => "", "nota" => "texto", "position" => "2", "parent_id" => "216", "is_visible" => "1", "codapl" => "ME", "tipo" => "E"],
