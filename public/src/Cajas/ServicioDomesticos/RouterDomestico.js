...
import { ControllerDomesticos } from './ControllerDomesticos';

class RouterDomestico extends ApruebaRouter {
	constructor(options) {
		super({
			...options,
			routes: {
			...
			controller: $App.startSubApplication(ControllerDomesticos, '', {
				content: '#boneLayout',
			}),
		});
	}
