...
<link rel="stylesheet" href="{{ versioned_asset('mercurio/build/Mercurio32.css') }}" />
@endpush
...
<script type="text/template" id='tmp_table'>
    @include('mercurio/conyuge/tmp/tmp_table')
    </script>

<script type="text/template" id='tmp_create'>
    @include('mercurio/conyuge/tmp/tmp_create')
    </script>
...
<script src="{{ versioned_asset('mercurio/build/Mercurio32.js') }}"></script>
@endpush