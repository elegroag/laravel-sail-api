@php echo Tag::hiddenField("permiso_menu"); @endphp
<link href="{{ asset('Cajas/principal.css') }}" rel="stylesheet">
...
<script src="{{ asset('Cajas/inicio/build.inicio.js') }}"></script>
