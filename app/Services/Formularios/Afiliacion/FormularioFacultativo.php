...
class FormularioFacultativo extends Documento
{
    ...
    function dataEmpleador()
    {
        ...
        $datos = array(
            ...
            array('lb' => 'nit', 'texto' => $this->facultativo->getCedtra(), 'x' => 158, 'y' => 48),
            array('lb' => 'Sucursal', 'texto' => $razon_social, 'x' => 9, 'y' => 56),
            array('lb' => 'Telefono', 'texto' => $this->facultativo->getTelefono(), 'x' => 170, 'y' => 56),
        );
        $this->addBloq($datos);
    }
    ...
    function dataTrabajador()
    {
        ...
        $datos = array(
            array('lb' => 'Cedula trabajador', 'texto' => $this->facultativo->getCedtra(), 'x' => 10, 'y' => 66),
            $this->posTipoDocumento(66),
            array('lb' => 'Celular', 'texto' => $this->facultativo->getTelefono(), 'x' => 82, 'y' => 66),
            array('lb' => 'Email', 'texto' => $this->facultativo->getEmail(), 'x' => 125, 'y' => 66),
            array('lb' => 'Primer apellido', 'texto' => $this->facultativo->getPriape(), 'x' => 10, 'y' => 74),
            array('lb' => 'Segundo apellido', 'texto' => $this->facultativo->getSegape(), 'x' => 54, 'y' => 74),
            array('lb' => 'Primer nombre', 'texto' => $this->facultativo->getPrinom(), 'x' => 105, 'y' => 74),
            array('lb' => 'Segundo nombre', 'texto' => $this->facultativo->getSegnom(), 'x' => 155, 'y' => 74),
            array('lb' => 'Fecha nacimiento año', 'texto' => substr($this->facultativo->getFecnac(), 0, 4), 'x' => 15, 'y' => 83),
            array('lb' => 'Fecha nacimiento mes', 'texto' => substr($this->facultativo->getFecnac(), 5, 2), 'x' => 31, 'y' => 83),
            array('lb' => 'Fecha nacimiento día', 'texto' => substr($this->facultativo->getFecnac(), 8, 2), 'x' => 45, 'y' => 83),
            $this->posSexo(82),
            $this->posEstadoCivil(82),
            $this->posZonaResidencial(82),
            array('lb' => 'Dirección recidencia', 'texto' => $this->facultativo->getDireccion(), 'x' => 10, 'y' => 91),
            array('lb' => 'Barrio', 'texto' => $this->facultativo->getBarrio(), 'x' => 70, 'y' => 91),
    ...
    function dataLaboral()
    {
        ...
        $datos = array(
            array('lb' => 'Fecha inicia año', 'texto' => substr($this->facultativo->getFecini(), 0, 4), 'x' => 15, 'y' => 163),
            array('lb' => 'Fecha inicia mes', 'texto' => substr($this->facultativo->getFecini(), 5, 2), 'x' => 31, 'y' => 163),
            array('lb' => 'Fecha inicia día', 'texto' => substr($this->facultativo->getFecini(), 8, 2), 'x' => 45, 'y' => 163),
            array('lb' => 'Tipo contrato', 'texto' => 'X', 'x' => 80, 'y' => 163),
            array('lb' => 'Jornada', 'texto' => 'X', 'x' => 92, 'y' => 163),
            array('lb' => 'Salario', 'texto' => $this->facultativo->getSalario(), 'x' => 135, 'y' => 163),
            array('lb' => 'Comisión', 'texto' => 'X', 'x' => 182, 'y' => 163),
            array('lb' => 'Sector agro', 'texto' => 'X', 'x' => 195, 'y' => 163),
            array('lb' => 'Direccion laboral', 'texto' => $this->facultativo->getDireccion(), 'x' => 10, 'y' => 171),
    ...
    function dataMedioPago()
    {
        ...
        $datos = array(
            ...
            array('lb' => 'Documento beneficio giro', 'texto' => $this->facultativo->getCedtra(), 'x' => 112, 'y' => 189),
            array('lb' => 'Tipo afiliado beneficio', 'texto' => 'X', 'x' => 164, 'y' => 189),
            $this->posTipoPago(198),
            array('lb' => 'Número cuenta', 'texto' => $this->facultativo->getNumcue(), 'x' => 52, 'y' => 198),
