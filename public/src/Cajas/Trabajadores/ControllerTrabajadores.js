            ...
            callback: (response) => {
                if (response) {
                    app.infoRequest({
                        ...
                        entity: new TrabajadorAprobarModel({
                            id: response.data.id,
                            codsuc: response.data.codsuc,
                            codlis: response.data.codlis,
                            tippag: response.data.tippag,
                            numcue: response.data.numcue,
                            codban: response.data.codban,
                            tipcue: response.data.tipcue,
                            fecafi: response.data.fecing,
                            fecpre: response.data.fecsol,
                        }),
                    });
                }
            },
