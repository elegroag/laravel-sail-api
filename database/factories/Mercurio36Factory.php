...
/**
 * Factory para el modelo Mercurio36.
 * Genera datos de prueba para la tabla mercurio36.
 */
class Mercurio36Factory extends Factory
{
    /**
     * El modelo asociado con este factory.
     */
    protected $model = Mercurio36::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'repleg' => $this->faker->optional()->text(140),
            ...
            'numcue' => $this->faker->optional()->numerify('####################'),
