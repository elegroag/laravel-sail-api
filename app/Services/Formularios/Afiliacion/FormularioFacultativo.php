...
class FormularioFacultativo extends Documento
{
    ...
    public function main()
    {
        ...
        $this->pdf->SetAuthor("{$this->facultativo->getNombreCompleto()}, COMFACA");
        ...
        if ($this->facultativo->getTippag() != 'T') {
            $this->dataMedioPago();
        }
        $this->addBloq([
    ...
    public function tipoAfiliado()
    {
        ...
        $datos = [
            ['lb' => 'Tipo novedad', 'texto' => 'X', 'x' => 38, 'y' => 36.5],
    ...
    public function dataEmpleador()
    {
        ...
        $razon_social = capitalize($this->facultativo->getNombreCompleto());
        $datos = [
            ['lb' => 'Razon social', 'texto' => $razon_social, 'x' => 9, 'y' => 48],
            ['lb' => 'nit', 'texto' => $this->facultativo->getCedtra(), 'x' => 158, 'y' => 48],
            ['lb' => 'Sucursal', 'texto' => $razon_social, 'x' => 9, 'y' => 56],
            ['lb' => 'Telefono', 'texto' => $this->facultativo->getTelefono(), 'x' => 170, 'y' => 56],
        ];
        $this->addBloq($datos);
    }
    ...
    public function dataTrabajador()
    {
        ...
        $datos = [
            ['lb' => 'Cedula trabajador', 'texto' => $this->facultativo->getCedtra(), 'x' => 10, 'y' => 66],
            $this->posTipoDocumento(66),
            ['lb' => 'Celular', 'texto' => $this->facultativo->getTelefono(), 'x' => 82, 'y' => 66],
            ['lb' => 'Email', 'texto' => $this->facultativo->getEmail(), 'x' => 125, 'y' => 66],
            ['lb' => 'Primer apellido', 'texto' => $this->facultativo->getPriape(), 'x' => 10, 'y' => 74],
            ['lb' => 'Segundo apellido', 'texto' => $this->facultativo->getSegape(), 'x' => 54, 'y' => 74],
            ['lb' => 'Primer nombre', 'texto' => $this->facultativo->getPrinom(), 'x' => 105, 'y' => 74],
            ['lb' => 'Segundo nombre', 'texto' => $this->facultativo->getSegnom(), 'x' => 155, 'y' => 74],
            ['lb' => 'Fecha nacimiento año', 'texto' => substr($this->facultativo->getFecnac(), 0, 4), 'x' => 15, 'y' => 83],
            ['lb' => 'Fecha nacimiento mes', 'texto' => substr($this->facultativo->getFecnac(), 5, 2), 'x' => 31, 'y' => 83],
            ['lb' => 'Fecha nacimiento día', 'texto' => substr($this->facultativo->getFecnac(), 8, 2), 'x' => 45, 'y' => 83],
            $this->posSexo(82),
            $this->posEstadoCivil(82),
            $this->posZonaResidencial(82),
            ['lb' => 'Dirección recidencia', 'texto' => $this->facultativo->getDireccion(), 'x' => 10, 'y' => 91],
            ['lb' => 'Barrio', 'texto' => $this->facultativo->getBarrio(), 'x' => 70, 'y' => 91],
    ...
    public function dataLaboral()
    {
        ...
        $datos = [
            ['lb' => 'Fecha inicia año', 'texto' => substr($this->facultativo->getFecini(), 0, 4), 'x' => 15, 'y' => 163],
            ['lb' => 'Fecha inicia mes', 'texto' => substr($this->facultativo->getFecini(), 5, 2), 'x' => 31, 'y' => 163],
            ['lb' => 'Fecha inicia día', 'texto' => substr($this->facultativo->getFecini(), 8, 2), 'x' => 45, 'y' => 163],
            ['lb' => 'Tipo contrato', 'texto' => 'X', 'x' => 80, 'y' => 163],
            ['lb' => 'Jornada', 'texto' => 'X', 'x' => 92, 'y' => 163],
            ['lb' => 'Salario', 'texto' => $this->facultativo->getSalario(), 'x' => 135, 'y' => 163],
            ['lb' => 'Comisión', 'texto' => 'X', 'x' => 182, 'y' => 163],
            ['lb' => 'Sector agro', 'texto' => 'X', 'x' => 195, 'y' => 163],
            ['lb' => 'Direccion laboral', 'texto' => $this->facultativo->getDireccion(), 'x' => 10, 'y' => 171],
            $this->posZonaLaboral(171),
            ['lb' => 'Otra empresa', 'texto' => 'X', 'x' => 25, 'y' => 179],
            ['lb' => 'Ocupación', 'texto' => substr($cargo, 0, 64), 'x' => 117, 'y' => 179],
        ];
        $this->addBloq($datos);
    }
    ...
    public function dataMedioPago()
    {
        ...
        $nombre = capitalize($this->facultativo->getNombreCompleto());
        $datos = [
            ['lb' => 'Nombre beneficio giro', 'texto' => $nombre, 'x' => 10, 'y' => 189],
            ['lb' => 'Documento beneficio giro', 'texto' => $this->facultativo->getCedtra(), 'x' => 112, 'y' => 189],
            ['lb' => 'Tipo afiliado beneficio', 'texto' => 'X', 'x' => 164, 'y' => 189],
            $this->posTipoPago(198),
            ['lb' => 'Número cuenta', 'texto' => $this->facultativo->getNumcue(), 'x' => 52, 'y' => 198],
            ['lb' => 'Banco', 'texto' => capitalize($banco), 'x' => 112, 'y' => 197],
        ];
        $this->addBloq($datos);
    }
    ...
    {
        if ($this->facultativo->getTipafi() == '3') {
            $x = 155;
            // 2%
        } elseif ($this->facultativo->getTipafi() == '65') {
            // 0.6%
            $x = 150;
        } else {
            // 4%
