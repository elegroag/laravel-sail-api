<?= Tag::form("#", "id: formulario_beneficiario", "class: validation_form", "autocomplete: off", "novalidate"); ?>
<?= Tag::numericField("id", "class: d-none", "placeholder: id", "value: {$mercurio34->getId()}"); ?>
<div class="row">
	<div class="col-md-2">
