	...
	<div class='row g-3'>
		<div class='col-md-4' group-for='giro'>
			<div class='d-flex align-items-center'>
				...
				@php
					$value = ($mercurio34) ? $mercurio34->getGirol() : '';
					echo Tag::selectStatic("giro", $_giro, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción");
				@endphp
		...
		<div class='col-md-4' group-for='fecafi'>
			<div class='d-flex align-items-center'>
				...
				@php
					$value = ($mercurio34) ? $mercurio34->getGirol() : '';
					echo Tag::calendar("fecafi", "class: form-control", "placeholder: Fecha de afiliación");
				@endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='fecapr'>
			<div class='d-flex align-items-center'>
				...
				@php
					$value = ($mercurio34) ? $mercurio34->getGirol() : '';
					echo Tag::calendar("fecapr", "class: form-control", "placeholder: Fecha de aprobación");
				@endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='fecapr'>
			<div class='d-flex align-items-center'>
				...
				@php
					$value = ($mercurio34) ? $mercurio34->getGirol() : '';
					echo Tag::calendar("fecpre", "class: form-control", "placeholder: Fecha de aprobación");
				@endphp
			</div>
		</div>
