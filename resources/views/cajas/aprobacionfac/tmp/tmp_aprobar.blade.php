	...
	<div class='row g-3'>
		...
		<div class='col-md-6 col-lg-3' group-for='tipdur'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("tipdur", $_tipdur, "use_dummy: true", "dummyValue: Seleccione duración", "class: form-select", "placeholder: Seleccione duración"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-3' group-for='codind'>
			<div class='d-flex align-items-center'>
				<label for='codind' class='form-label me-2 mb-0 flex-shrink-0'>Indice</label>
				@php echo Tag::selectStatic("codind", $_codind, "use_dummy: true", "dummyValue: Seleccione un índice", "class: form-select", "placeholder: Seleccione un índice"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-3' group-for='todmes'>
			<div class='d-flex align-items-center'>
				<label for='todmes' class='form-label me-2 mb-0 flex-shrink-0'>Paga mes</label>
				@php echo Tag::selectStatic("todmes", $_todmes, "use_dummy: true", "dummyValue: Seleccione opción", "class: form-select", "placeholder: Seleccione opción"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-3' group-for='forpre'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("forpre", $_forpre, "use_dummy: true", "dummyValue: Seleccione forma", "class: form-select", "placeholder: Seleccione forma"); @endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='codsuc'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::textField("codsuc", "class: form-control", "placeholder: Ingrese sucursal planilla", "maxlength: 3"); @endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='tippag'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("tippag", $_tippag, "use_dummy: true", "dummyValue: Seleccione tipo de pago", "class: form-select", "placeholder: Seleccione tipo de pago"); @endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='codban'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("codban", $_bancos, "use_dummy: true", "dummyValue: Seleccione banco", "class: form-select", "value:", "placeholder: Seleccione banco"); @endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='tipcue'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("tipcue", $_tipcue, "use_dummy: true", "dummyValue: Seleccione tipo de cuenta", "class: form-select", "placeholder: Seleccione tipo de cuenta"); @endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='giro'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("giro", $_giro, "use_dummy: true", "class: form-select", "placeholder: Seleccione giro"); @endphp
			</div>
		</div>
		<div class='col-md-4' group-for='codgir'>
			<div class='d-flex align-items-center'>
				<label for='codgir' class='form-label me-2 mb-0 flex-shrink-0'>Motivo no giro</label>
				@php echo Tag::selectStatic("codgir", $_codgir, "use_dummy: true", "class: form-select", "placeholder: Seleccione motivo"); @endphp
			</div>
		</div>
