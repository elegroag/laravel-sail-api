	...
	<div class='row g-3'>
		...
		<div class='col-md-6 col-lg-3' group-for='pymes'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("pymes", $_pymes, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-3' group-for='contratista'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("contratista", $_contratista, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-3' group-for='tipemp'>
			<div class='d-flex align-items-center'>
				<label for='tipemp' class='form-label me-2 mb-0 flex-shrink-0'>Tipo empresa</label>
				@php echo Tag::selectStatic("tipemp", $_tipemp, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-3' group-for='tipapo'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("tipapo", $_tipapo, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-4' group-for='tipsoc'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::selectStatic("tipsoc", $_tipsoc, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-4' group-for='ofiafi'>
			<div class='d-flex align-items-center'>
				<label for='ofiafi' class='form-label me-2 mb-0 flex-shrink-0'>Oficina</label>
				@php echo Tag::selectStatic("ofiafi", $_ofiafi, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción"); @endphp
			</div>
		</div>
		<div class='col-md-6 col-lg-4' group-for='colegio'>
			<div class='d-flex align-items-center'>
				<label for='colegio' class='form-label me-2 mb-0 flex-shrink-0'>Colegio</label>
				@php echo Tag::selectStatic("colegio", $_colegio, "use_dummy: true", "dummyValue: ", "class: form-select", "placeholder: Selecciona una opción"); @endphp
			</div>
		</div>
		...
		<div class='col-md-4' group-for='actapr'>
			<div class='d-flex align-items-center'>
				...
				@php echo Tag::textField("actapr", "placeholder: Acta de aprobación", "class: form-control"); @endphp
			</div>
		</div>
		<div class='col-md-4' group-for='diahab'>
			<div class='d-flex align-items-center'>
				<label for='diahab' class='form-label me-2 mb-0 flex-shrink-0'>Día habil de Pago</label>
				@php echo Tag::textField("diahab", "placeholder: Días habiles", "class: form-control"); @endphp
			</div>
		</div>
		<div class='col-md-3' group-for='fecafi'>
			<div class='d-flex align-items-center'>
				<label for='fecafi' class='form-label me-2 mb-0 flex-shrink-0'>Fecha afiliación</label>
				@php echo Tag::calendar("fecafi", "placeholder: Fecha de afiliación", "class: form-control"); @endphp
			</div>
		</div>
