...
class ParamsConyuge
{
    ...
    static $tipo_cuenta;
    static $recibe_subsidio;
    static $companero_permanente;
    ...
    public static function getCompaneroPermanente()
    {
        if (is_null(self::$companero_permanente) == true) {
            foreach (self::$datos_captura['companero_permanente'] as $data) self::$companero_permanente[$data['estado']] = $data['detalle'];
        }
    ...
    public static function getRecibeSubsidio()
    {
        if (is_null(self::$recibe_subsidio) == true) {
            foreach (self::$datos_captura['recibe_subsidio'] as $data) self::$recibe_subsidio[$data['estado']] = $data['detalle'];
        }
    ...
    public static function getCodigoCuenta()
    {
        if (is_null(self::$codigo_cuenta) == true) {
            foreach (self::$datos_captura['codigo_cuenta'] as $data) self::$codigo_cuenta[$data['codcue']] = $data['detalle'];
        }
