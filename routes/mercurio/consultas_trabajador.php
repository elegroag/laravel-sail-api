...
Route::middleware([EnsureCookieAuthenticated::class])->group(function () {
    Route::prefix('mercurio/subsidio')->group(function () {
        Route::get('/', function () {
            return redirect()->route('subsidio.historial');
        });
        Route::get('historial', [ConsultasTrabajadorController::class, 'historial'])->name('subsidio.historial');
        ...
        Route::get('certificado_afiliacion_view', [ConsultasTrabajadorController::class, 'certificadoAfiliacionView']);
