...
Tag::addJavascript('Cajas/movile/mercurio52');
                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Tag::textUpperField("codmen", "class: form-control", "placeholder: Menu"); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Tag::select("codare", $Mercurio55->find(), "using: codare,detalle", "use_dummy: true", "dummyValue: ", "class: form-control"); ?>
                        </div>
                        <div class="form-group">
