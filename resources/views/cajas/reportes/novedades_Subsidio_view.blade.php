<div class="card mb-0">
	<div class="card-body">
		@php echo Tag::form("reportes/novedades_Subsidio","id: form","class: validation_form","autocomplete: off","novalidate"); @endphp
		<div class="row">
		<div class="col-md-2 ml-auto">
			<div class="form-group">
				<label for="fecini" class="form-control-label">Fecha Inicial</label>
				@php echo Tag::calendar("fecini","placeholder: Fecha Inicial","class: form-control"); @endphp
			</div>
		</div>
		<div class="col-md-2">
			<div class="form-group">
...
<script src="{{ asset('Cajas/reportes.js') }}"></script>
