<main style='margin-top:100px'>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1><?=$flash['code']?></h1>
        <h2>¡UH UFF! Estas perdido.</h2>
        <? if(isset($flash['message']) & $flash['message'] != ""){ ?>
            <p><?=$flash['message']?></p>
        <? }else{ ?>
            <p>La página que buscas no existe. Cómo llegaste aquí es un misterio. Pero puede hacer clic en el botón de abajo para volver a la página de inicio.</p>
        <? } ?>
        <?=Tag::linkTo("login/index", "INICIO", "class: btn bg-green text-white")?>
      </div>
    </div>
  </div>
</main>