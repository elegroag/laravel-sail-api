...
/**
 * Factory para el modelo Mercurio39.
 * Genera datos de prueba para la tabla mercurio39.
 */
class Mercurio39Factory extends Factory
{
    /**
     * El modelo asociado con este factory.
     */
    protected $model = Mercurio39::class;
