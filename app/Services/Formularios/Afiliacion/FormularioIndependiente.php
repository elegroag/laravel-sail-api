...
class FormularioIndependiente extends Documento
{
    ...
    public function main()
    {
        ...
        $this->pdf->Cell(15, 4, 'R-UI: ' . $this->independiente->ruuid, 0, 0, 'C');
    ...
    public function dataEmpleador()
    {
        ...
        $datos = [
            ...
            ['lb' => 'nit', 'texto' => $this->independiente->getCedtra(), 'x' => 158, 'y' => 48],
            ['lb' => 'Sucursal', 'texto' => $razon_social, 'x' => 9, 'y' => 56],
            ['lb' => 'Telefono', 'texto' => $this->independiente->getTelefono(), 'x' => 170, 'y' => 56],
        ];
        $this->addBloq($datos);
    }
    ...
    public function dataTrabajador()
    {
        ...
        $datos = [
            ['lb' => 'Cedula trabajador', 'texto' => $this->independiente->getCedtra(), 'x' => 10, 'y' => 66],
            $this->posTipoDocumento(66),
            ['lb' => 'Celular', 'texto' => $this->independiente->getTelefono(), 'x' => 82, 'y' => 66],
            ['lb' => 'Email', 'texto' => $this->independiente->getEmail(), 'x' => 125, 'y' => 66],
            ['lb' => 'Primer apellido', 'texto' => $this->independiente->getPriape(), 'x' => 10, 'y' => 74],
            ['lb' => 'Segundo apellido', 'texto' => $this->independiente->getSegape(), 'x' => 54, 'y' => 74],
            ['lb' => 'Primer nombre', 'texto' => $this->independiente->getPrinom(), 'x' => 105, 'y' => 74],
            ['lb' => 'Segundo nombre', 'texto' => $this->independiente->getSegnom(), 'x' => 155, 'y' => 74],
            ['lb' => 'Fecha nacimiento año', 'texto' => substr($this->independiente->getFecnac(), 0, 4), 'x' => 15, 'y' => 83],
            ['lb' => 'Fecha nacimiento mes', 'texto' => substr($this->independiente->getFecnac(), 5, 2), 'x' => 31, 'y' => 83],
            ['lb' => 'Fecha nacimiento día', 'texto' => substr($this->independiente->getFecnac(), 8, 2), 'x' => 45, 'y' => 83],
            $this->posSexo(82),
            $this->posEstadoCivil(82),
            $this->posZonaResidencial(82),
            ['lb' => 'Dirección recidencia', 'texto' => $this->independiente->getDireccion(), 'x' => 10, 'y' => 91],
            ['lb' => 'Barrio', 'texto' => $this->independiente->getBarrio(), 'x' => 70, 'y' => 91],
    ...
    public function dataLaboral()
    {
        ...
        $datos = [
            ['lb' => 'Fecha inicia año', 'texto' => substr($this->independiente->getFecini(), 0, 4), 'x' => 15, 'y' => 163],
            ['lb' => 'Fecha inicia mes', 'texto' => substr($this->independiente->getFecini(), 5, 2), 'x' => 31, 'y' => 163],
            ['lb' => 'Fecha inicia día', 'texto' => substr($this->independiente->getFecini(), 8, 2), 'x' => 45, 'y' => 163],
            ['lb' => 'Tipo contrato', 'texto' => 'X', 'x' => 80, 'y' => 163],
            ['lb' => 'Jornada', 'texto' => 'X', 'x' => 92, 'y' => 163],
            ['lb' => 'Salario', 'texto' => $this->independiente->getSalario(), 'x' => 135, 'y' => 163],
            ['lb' => 'Comisión', 'texto' => 'X', 'x' => 182, 'y' => 163],
            ['lb' => 'Sector agro', 'texto' => 'X', 'x' => 195, 'y' => 163],
            ['lb' => 'Direccion laboral', 'texto' => $this->independiente->getDireccion(), 'x' => 10, 'y' => 171],
    ...
    public function dataMedioPago()
    {
        ...
        $datos = [
            ...
            ['lb' => 'Documento beneficio giro', 'texto' => $this->independiente->getCedtra(), 'x' => 112, 'y' => 189],
            ['lb' => 'Tipo afiliado beneficio', 'texto' => 'X', 'x' => 164, 'y' => 189],
            $this->posTipoPago(198),
            ['lb' => 'Número cuenta', 'texto' => $this->independiente->getNumcue(), 'x' => 52, 'y' => 198],
