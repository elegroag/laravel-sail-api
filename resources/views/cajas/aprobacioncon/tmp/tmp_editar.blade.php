...
<div class='card-body'>
	<div class="col-xs-12">
		<form method='POST' action="#" id='formulario_trabajador'>
			@php echo Tag::numericField("id", "class: d-none", "value: $id"); @endphp
			<div class="row">
				<div class='col-md-5'>
					<div class='form-group'>
						<label for='cedtra' class='form-control-label'>Trabajador afiliado activo</label>
						@php echo Tag::numericField("cedtra", "value: " . $mercurio32->getCedtra(), "use_dummy: true", "class: form-control", "disabled: "); @endphp
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						echo Tag::calendar("fecing", "class: form-control", "placeholder: Fecha Ingreso", "value: $value");
					@endphp
					</div>
				</div>
			</div>
