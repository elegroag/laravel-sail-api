...
<div class="card mb-0">
    <div class="card-body">
        <?php echo Tag::form("consultafoninez/reporte_general", "id: form", "class: validation_form", "autocomplete: off", "novalidate"); ?>
        <div class="row">
            ...
            <div class="col-md-auto d-flex mr-auto">
                <button type="button" class="btn btn-danger align-self-center" onclick="reporte_general();">Reporte</button>
            </div>
        </div>
