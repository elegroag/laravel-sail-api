...
class ActiveRecordBase
{
     ...
     */
    public function inQueryAssoc(string $sqlQuery): ?array
    {
    ...
    public function inQueryNum(string $sqlQuery): ?array
    {
        $results = DB::select($sqlQuery);
     ...
     * function fetchOne
     */
    public function fetchOne(string $sqlQuery): ?array
    {
        $results = DB::select($sqlQuery);
        if (count($results) > 0) {
    ...
    public function insert(string $table, array $values, array $fields, ?bool $automaticQuotes = false)
    {
    ...
    public function update(string $table, array $fieldsArray, array $valuesArray, ?string $whereCondition = null, ?bool $automaticQuotes = false)
    {
        $setClause = '';
