...
class IndependienteDatoPersonales extends Documento
{
    ...
    public function bloqueEmpresa()
    {
        ...
        $datos = [
            ...
            ['lb' => 'Cedula', 'texto' => $this->independiente->getCedtra(), 'x' => 151, 'y' => 100],
            ['lb' => 'Ciudad', 'texto' => $ciudad, 'x' => 50, 'y' => 108],

            ['lb' => 'Fecha', 'texto' => $this->independiente->getFecsol(), 'x' => 151, 'y' => 108],
            ['lb' => 'Dirección', 'texto' => $this->independiente->getDireccion(), 'x' => 70, 'y' => 118],

            ['lb' => 'Telefono', 'texto' => $this->independiente->getTelefono(), 'x' => 70, 'y' => 128],
            ['lb' => 'Celular', 'texto' => $this->independiente->getCelular(), 'x' => 151, 'y' => 128],
            ['lb' => 'Email', 'texto' => $this->independiente->getEmail(), 'x' => 70, 'y' => 138],
        ];
