...
Models (ModelBase, ActiveRecord sin bindings, get/set MercurioNN): inventario en `docs/generales/deuda-models-checklist.md`. No implementar hasta que Ricardo elija alcance.
