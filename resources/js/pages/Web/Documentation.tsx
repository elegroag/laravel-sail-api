                        ...
                        {manuales.map((manual) => (
                            <div key={manual.id} className={cn(
                                ...
                                <div className="flex items-start justify-between gap-2 mb-2">
                                    ...
                                    {manual.disabled && (
                                        <span className="text-xs bg-gray-100 text-gray-500 px-2 py-1 rounded-full flex-shrink-0">Próximamente</span>
                                    )}
                                </div>
                                <p className="text-sm text-gray-500 mb-4 flex-1">{manual.description}</p>
                                <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                                    {manual.size && <span className="text-xs text-gray-400">{manual.size}</span>}
                                    {manual.disabled ? (
