...
<script id='tmp_filtro' type="text/template">
    @include('cajas/aprobacionfac/tmp/tmp_filtro')
</script>
...
<script type="text/template" id='tmp_aprobar'>
    @include('cajas/aprobacionfac/tmp/tmp_aprobar')
</script>
...
<script id='tmp_sisu' type='text/template'>
    @include('cajas/aprobacionfac/tmp/tmp_sisu')
</script>
...
<script id='tmp_table' type="text/template">
    ...
    <div class='card-footer'>
        <div style='float:right'>
            <a class='btn btn-xs' id='btPendienteEmail' data-href="aprobacionfac/pendiente_email">Procesar Notificación Pendiente</a>
        </div>
    </div>
    <div id='filtro'></div>
</script>

<script src="{{ asset('Cajas/build/Facultativos.js') }}"></script>
@endpush
