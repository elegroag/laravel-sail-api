...
Route::middleware([CajasCookieAuthenticated::class])->group(function () {
    Route::prefix('aprobaciontra')->group(function () {
        Route::get('/', [ApruebaTrabajadorController::class, 'indexAction']);
        Route::post('aplicar-filtro', [ApruebaTrabajadorController::class, 'aplicarFiltroAction']);
        Route::post('buscar', [ApruebaTrabajadorController::class, 'buscarAction']);
