...
class ApiEndpointsSeeder extends Seeder
{
    ...
    private const TABLE = 'api_endpoints';
    ...
    {
        $sqlPath = database_path('seeders/dbsql/api_endpoints.sql');

        if (! File::exists($sqlPath)) {
            throw new RuntimeException('No se encontró el archivo SQL para el seeder api_endpoints.');
        }
