...
return new class extends Migration
{
    ...
    {
        Schema::create('mercurio41', function (Blueprint $table) {
            // Motor InnoDB
            $table->engine = 'InnoDB';
            ...
            $table->index(['tipo', 'coddoc', 'documento'], 'mercurio41_FK');
            $table->index('ruuid', 'fk_mercurio41_ruuid');
            $table->unique('ruuid', 'unique_mercurio41_ruuid');

            $table->foreign(['tipo', 'coddoc', 'documento'], 'mercurio41_FK')
    ...
    public function down(): void
    {
        Schema::table('mercurio41', function (Blueprint $table) {
            $table->dropForeign('mercurio41_FK');
            $table->dropIndex('mercurio41_FK');
            $table->dropIndex('fk_mercurio41_ruuid');
            $table->dropUnique('unique_mercurio41_ruuid');
        });
        Schema::dropIfExists('mercurio41');
    }
};
