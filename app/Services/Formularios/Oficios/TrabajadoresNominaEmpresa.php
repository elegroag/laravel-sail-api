...
class TrabajadoresNominaEmpresa extends DocumentoAdapter
{
    ...
    function bloqueEmpresa()
    {
        ...
        $tbl->set_heading(array(
            array('data' => 'ID', 'width' => '30mm'),
            array('data' => 'Nombre', 'width' => '40mm'),
            array('data' => 'Salario', 'width' => '30mm'),
            array('data' => 'Fecha inicia', 'width' => '20mm'),
            array('data' => 'Cargo', 'width' => '70mm'),
        ));

        foreach ($this->tranoms as $tranom) {
            $tbl->add_row(array(
                array('data' => $tranom->getCedtra(), 'width' => '30mm'),
                array('data' => capitalize($tranom->getNomtra() . ' ' . $tranom->getApetra()), 'width' => '40mm'),
                array('data' => '$ ' . number_format($tranom->getSaltra(), 0, ".", "."), 'width' => '30mm'),
                array('data' => $tranom->getFectra(), 'width' => '20mm'),
                array('data' => $tranom->getCartra(), 'width' => '70mm'),
            ));
        }
        $html = $tbl->generate();
