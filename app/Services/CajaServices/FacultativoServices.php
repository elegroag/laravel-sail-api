...
class FacultativoServices
{
    ...
    public function loadDisplay(Mercurio36 $mercurio36): void
    {
     ...
     */
    public function rechazar(Mercurio36 $mercurio36, string $nota, string $codest): bool
    {
        $today = Carbon::now();
        $id = $mercurio36->getId();
     ...
     * @author elegroag <elegroag@ibero.edu.co>
     */
    public function msjDevolver(Mercurio36 $mercurio36, string $nota): string
    {
     ...
     * @author elegroag <elegroag@ibero.edu.co>
     */
    public function msjRechazar(Mercurio36 $mercurio36, string $nota): string
    {
        return 'La Caja de Compensación Familiar Comfaca, ha recepcionado y validado la solicitud de afiliación, '.
            "emitida por la persona:  {$mercurio36->getPrinom()} {$mercurio36->getSegnom()} {$mercurio36->getPriape()} {$mercurio36->getSegape()} con identificación: {$mercurio36->getCedtra()}.<br/>".
     ...
     * @author elegroag <elegroag@ibero.edu.co>
     */
    public function adjuntos(Mercurio36 $mercurio36): mixed
    {
     ...
     * @author elegroag <elegroag@ibero.edu.co>
     */
    public function seguimiento(Mercurio36 $mercurio36): mixed
    {
