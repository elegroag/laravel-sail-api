...
@push('scripts')
    ...
    <script>
        window.ServerController = 'mercurio73';
    </script>

    <script src="{{ versioned_asset('cajas/build/Mercurio73.js') }}"></script>
@endpush
