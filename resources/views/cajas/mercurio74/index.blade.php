...
@push('scripts')
    ...
    <script>
        window.ServerController = 'mercurio74';
    </script>

    <script src="{{ versioned_asset('cajas/build/Mercurio74.js') }}"></script>
@endpush
