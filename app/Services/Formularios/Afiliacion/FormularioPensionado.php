...
class FormularioPensionado extends Documento
{
    ...
    function tipoAfiliado()
    {
        ...
        $this->pdf->SetAutoPageBreak(false, 0);
        $datos = array(
            array('lb' => 'Tipo novedad', 'texto' => 'X', 'x' => 38, 'y' => 38),
    ...
    function dataEmpleador()
    {
        ...
        $datos = array(
            ...
            array('lb' => 'nit', 'texto' => $this->pensionado->getCedtra(), 'x' => 158, 'y' => 48),
            array('lb' => 'Sucursal', 'texto' => $razon_social, 'x' => 9, 'y' => 56),
            array('lb' => 'Telefono', 'texto' => $this->pensionado->getTelefono(), 'x' => 170, 'y' => 56),
        );
        $this->addBloq($datos);
    }
    ...
    function dataTrabajador()
    {
        ...
        $datos = array(
            array('lb' => 'Cedula trabajador', 'texto' => $this->pensionado->getCedtra(), 'x' => 10, 'y' => 66),
            $this->posTipoDocumento(66),
            array('lb' => 'Celular', 'texto' => $this->pensionado->getTelefono(), 'x' => 82, 'y' => 66),
            array('lb' => 'Email', 'texto' => $this->pensionado->getEmail(), 'x' => 125, 'y' => 66),
            array('lb' => 'Primer apellido', 'texto' => $this->pensionado->getPriape(), 'x' => 10, 'y' => 74),
            array('lb' => 'Segundo apellido', 'texto' => $this->pensionado->getSegape(), 'x' => 54, 'y' => 74),
            array('lb' => 'Primer nombre', 'texto' => $this->pensionado->getPrinom(), 'x' => 105, 'y' => 74),
            array('lb' => 'Segundo nombre', 'texto' => $this->pensionado->getSegnom(), 'x' => 155, 'y' => 74),
            array('lb' => 'Fecha nacimiento año', 'texto' => substr($this->pensionado->getFecnac(), 0, 4), 'x' => 15, 'y' => 83),
            array('lb' => 'Fecha nacimiento mes', 'texto' => substr($this->pensionado->getFecnac(), 5, 2), 'x' => 31, 'y' => 83),
            array('lb' => 'Fecha nacimiento día', 'texto' => substr($this->pensionado->getFecnac(), 8, 2), 'x' => 45, 'y' => 83),
            $this->posSexo(82),
            $this->posEstadoCivil(82),
            $this->posZonaResidencial(82),
            array('lb' => 'Dirección recidencia', 'texto' => $this->pensionado->getDireccion(), 'x' => 10, 'y' => 91),
            array('lb' => 'Barrio', 'texto' => $this->pensionado->getBarrio(), 'x' => 70, 'y' => 91),
    ...
    function dataLaboral()
    {
        ...
        $datos = array(
            array('lb' => 'Fecha inicia año', 'texto' => substr($this->pensionado->getFecini(), 0, 4), 'x' => 15, 'y' => 163),
            array('lb' => 'Fecha inicia mes', 'texto' => substr($this->pensionado->getFecini(), 5, 2), 'x' => 31, 'y' => 163),
            array('lb' => 'Fecha inicia día', 'texto' => substr($this->pensionado->getFecini(), 8, 2), 'x' => 45, 'y' => 163),
            array('lb' => 'Tipo contrato', 'texto' => 'X', 'x' => 80, 'y' => 163),
            array('lb' => 'Jornada', 'texto' => 'X', 'x' => 92, 'y' => 163),
            array('lb' => 'Salario', 'texto' => $this->pensionado->getSalario(), 'x' => 135, 'y' => 163),
            array('lb' => 'Comisión', 'texto' => 'X', 'x' => 182, 'y' => 163),
            array('lb' => 'Sector agro', 'texto' => 'X', 'x' => 195, 'y' => 163),
            array('lb' => 'Direccion laboral', 'texto' => $this->pensionado->getDireccion(), 'x' => 10, 'y' => 171),
            $this->posZonaLaboral(171),
            array('lb' => 'Otra empresa', 'texto' => 'X', 'x' => 25, 'y' => 179),
            array('lb' => 'Ocupación', 'texto' => substr($cargo, 0, 64), 'x' => 115, 'y' => 179),
        );
        $this->addBloq($datos);
    }
    ...
    function dataMedioPago()
    {
        ...
        $datos = array(
            ...
            array('lb' => 'Documento beneficio giro', 'texto' => $this->pensionado->getCedtra(), 'x' => 112, 'y' => 189),
            array('lb' => 'Tipo afiliado beneficio', 'texto' => 'X', 'x' => 164, 'y' => 189),
            $this->posTipoPago(198),
            array('lb' => 'Número cuenta', 'texto' => $this->pensionado->getNumcue(), 'x' => 52, 'y' => 198),
            array('lb' => 'Banco', 'texto' => capitalize($banco), 'x' => 112, 'y' => 198),
        );
        $this->addBloq($datos);
    }
