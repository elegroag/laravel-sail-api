...
import { $App } from '@/App';
import { ServicioAprobarModel } from './ServicioAprobarModel';

class DomesticoInfoView extends FormInfoView {
	constructor(options = {}) {
		super({
			...options,
			titulo: 'Aprobar servicio domestico',
			titulo_detalle: 'Lista servicio domestico',
			Rules: ServicioAprobarModel.Rules,
