		...
		<div class="row justify-content-around">
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
					...
					<div class="form-control bg-light">{{ $mercurio36->ruuid ?? '' }}</div>
				</div>
			</div>
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
			...
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
					...
					<div class="form-control bg-light">{{ $_calemp[$mercurio36->getCalemp()] ?? '' }}</div>
				</div>
			</div>
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
			...
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
					...
					<div class="form-control bg-light">{{ $_codciu[$mercurio36->getCodciu()] ?? '' }}</div>
				</div>
			</div>
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
					<label class="form-label text-muted small mb-1">Ciudad de Labor de Trabajadores</label>
					<div class="form-control bg-light">{{ $_codzon[$mercurio36->getCodzon()] ?? '' }}</div>
				</div>
			</div>
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
			...
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
					...
					<div class="form-control bg-light">{{ $_codact[$mercurio36->getCodact()] ?? '' }}</div>
				</div>
			</div>
			<div class="col-md-4 col-lg-3">
				<div class="form-group">
