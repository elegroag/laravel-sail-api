...
<link rel="stylesheet" href="{{ versioned_asset('mercurio/build/Mercurio471.css') }}">
@endpush
...
<script type="text/template" id='tmp_table'>
    @include('mercurio/actualizadatos/tmp/tmp_table')
    </script>

<script type="text/template" id='tmp_create'>
    @include('mercurio/actualizadatos/tmp/tmp_create')
    </script>
...
<script src="{{ versioned_asset('mercurio/build/Mercurio471.js') }}"></script>
@endpush