...
class EmpresaInformation extends ControllerValidation {
	tipo = null;
	headerMain = null;
	headerView = null;
	solicitudModel = null;
	...
	constructor(options = {}) {
		...
		this.titulo = 'Aprobar empresa';
		this.titulo_detalle = 'Lista empresas';
	...
	infoRequest(collection={}) {
		...
		const entity = new EmpresaAprobarModel({ id: this.solicitudModel.get('id') });
		const view = new EmpresaInfoView({
			model: entity,
