...
export default class FacultativoInfoView extends FormInfoView {
	constructor(options = {}) {
		super({
			...options,
			titulo: 'Aprobar facultativo',
			titulo_detalle: 'Lista facultativos',
			Rules: FacultativoAprobarModel.Rules,
