...
return [
    ...
    [
        ...
        'is_readonly' => true,
        'css_classes' => 'd-none',
        'help_text' => 'Campo de sistema - Calificación del afiliado',
        'target' => -1,
    ...
    [
        ...
        'validacion' => [
            ...
            'max_length' => 2,
            'field_size' => 2,
            'detail_info' => 'Tipo de documento de identificación del afiliado',
            'error_messages' => [
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Ingrese el primer nombre del trabajador',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'min_length' => 2,
            'max_length' => 100,
            'field_size' => 100,
            'detail_info' => 'Primer nombre del afiliado',
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Ingrese el primer apellido del trabajador',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'min_length' => 2,
    ...
    [
        ...
        'is_readonly' => false,
        'css_classes' => 'form-control',
        'help_text' => 'Ingrese la dirección del lugar de trabajo',
        'target' => -1,
        'validacion' => [
            'is_required' => false,
            'max_length' => 255,
    ...
    [
        ...
        'css_classes' => 'form-select',
        'help_text' => 'Seleccione la zona donde labora',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'css_classes' => 'form-select',
        'help_text' => '¿Trabaja en zona rural?',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    [
        ...
        'data_source' => [], // Se llenará dinámicamente
        'css_classes' => 'form-select',
        'help_text' => 'Seleccione el cargo que desempeña',
        'target' => -1,
        'validacion' => [
            'is_required' => true,
            'error_messages' => [
    ...
    // Grupo 5: Información de Afiliación
    [
        'formulario_id' => 5,
        'name' => 'tipafi',
        'type' => 'select',
    ...
    // Grupo 7: Información de Contacto
    [
        'formulario_id' => 5,
        'name' => 'email',
        'type' => 'email',
    ...
    [
        ...
        'validacion' => [
            ...
            'max_length' => 15,
            'field_size' => 15,
            'detail_info' => 'Número de teléfono fijo con indicativo',
            'pattern' => '^[0-9]{7,15}$',
            'error_messages' => [
    ...
    [
        ...
        'validacion' => [
            ...
            'max_length' => 15,
            'field_size' => 15,
            'detail_info' => 'Número de teléfono celular con indicativo',
            'pattern' => '^[0-9]{10,15}$',
            'error_messages' => [
                'required' => 'El celular es obligatorio',
                'min_length' => 'El celular debe tener al menos 10 dígitos',
                'max_length' => 'El celular no puede exceder 15 dígitos',
