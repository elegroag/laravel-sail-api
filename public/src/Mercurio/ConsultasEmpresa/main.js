...
$(() => {
    ...
    $(document).on('click', '#bt_ejemplo_planilla_activacion_masiva', EjemploPlanillaActivacionMasiva);
        ...
        $.ajax({
            ...
            .done(function (response) {
                if (response.success == false) {
                    ...
                    const modal = new bootstrap.Modal(document.getElementById('modalConsultaNucleo'), {
                        keyboard: true,
                        backdrop: 'static',
                    });
